/**********************************************************************************
 * $URL: http://ims-dev.googlecode.com/svn/trunk/basiclti/java-servlet/WEB-INF/classes/org/imsglobal/basiclti/BasicLTIUtil.java $
 * $Id: BasicLTIUtil.java 64 2009-08-29 23:05:14Z drchuck $
 **********************************************************************************
 *
 ...
 *
 **********************************************************************************/
package com.chico.esiuclm.melti.net.basiclti;
...
import com.chico.esiuclm.melti.net.basiclti.XMLMap;
import com.chico.esiuclm.melti.net.basiclti.Base64;
...
import com.chico.esiuclm.melti.net.oauth.signature.OAuthSignatureMethod;
...
public class BasicLTIUtil {
	...
	// Allow caller to internatonalize this for us...
	    ...
	    return nextProp;
        } catch (com.chico.esiuclm.melti.net.oauth.OAuthException e) {
