...
package com.chico.esiuclm.melti.net.oauth.client;
...
import com.chico.esiuclm.melti.net.oauth.OAuth;
...
import com.chico.esiuclm.melti.net.oauth.OAuthProblemException;
import com.chico.esiuclm.melti.net.oauth.http.HttpClient;
import com.chico.esiuclm.melti.net.oauth.http.HttpMessage;
import com.chico.esiuclm.melti.net.oauth.http.HttpMessageDecoder;
import com.chico.esiuclm.melti.net.oauth.http.HttpResponseMessage;
...
public class OAuthClient {
    ...
    throws IOException, OAuthException, URISyntaxException {
        ...
        com.chico.esiuclm.melti.net.oauth.ParameterStyle style = (ps == null) ? com.chico.esiuclm.melti.net.oauth.ParameterStyle.BODY
                : Enum.valueOf(com.chico.esiuclm.melti.net.oauth.ParameterStyle.class, ps.toString());
     ...
     *             the HTTP response status code was not 200 (OK)
     */
    public OAuthMessage invoke(OAuthMessage request,  com.chico.esiuclm.melti.net.oauth.ParameterStyle style)
     ...
     */
    public OAuthResponseMessage access(OAuthMessage request,  com.chico.esiuclm.melti.net.oauth.ParameterStyle style) throws IOException {
    ...
    public static enum ParameterStyle {
        AUTHORIZATION_HEADER (com.chico.esiuclm.melti.net.oauth.ParameterStyle.AUTHORIZATION_HEADER),
        BODY                 (com.chico.esiuclm.melti.net.oauth.ParameterStyle.BODY),
        QUERY_STRING         (com.chico.esiuclm.melti.net.oauth.ParameterStyle.QUERY_STRING);

        public com.chico.esiuclm.melti.net.oauth.ParameterStyle getReplacement() {
            return replacement;
        }

        private ParameterStyle(com.chico.esiuclm.melti.net.oauth.ParameterStyle replacement) {
            this.replacement = replacement;
        }

        private final com.chico.esiuclm.melti.net.oauth.ParameterStyle replacement;
    }
